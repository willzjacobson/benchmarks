<%@ Page Language="c#" Inherits="SmartBuilding.diboss_001_OccupancyPrediction" AutoEventWireup="true" CodeFile="OccupancyPrediction.aspx.cs" %>
        ...
        <tr>
            ...
            <br />
                <asp:Chart ID="Chart1" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Occupancy Prediction versus Actual" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                ...
                <asp:Chart ID="Chart2" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Root Mean Square Error (RMSE)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="true" IsTextAutoFit="true" Docking="Bottom" Name="Default" BackColor="Transparent"
            ...
            <td align="left" valign="top">
                <table align="center" cellpadding="4">
                    <tr>
                     ...
                     <tr>
                        <td  colspan="2" nowrap >
                            <asp:RadioButtonList ID="SensorTypeList" runat="server" RepeatColumns="2" AutoPostBack="True" CssClass="cblist">
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
