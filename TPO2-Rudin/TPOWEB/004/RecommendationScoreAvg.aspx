<%@ Page Language="c#" Inherits="SmartBuilding.diboss_004_RecommendationScoreAvg" AutoEventWireup="true" CodeFile="RecommendationScoreAvg.aspx.cs" %>
        ...
        <tr>
            <td valign="top" align="center">
                ...
                <asp:Chart ID="Chart3" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Start Up Score (2 Weeks Running Average)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                            ...
                            <AxisY LineColor="64, 64, 64, 64" Title="Percent" IsLabelAutoFit="False">
                ...
                <asp:Chart ID="Chart4" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Ramp Down Score (2 Weeks Running Average)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="true" IsTextAutoFit="true" TextWrapThreshold="50" Docking="Bottom" Name="Default" BackColor="Transparent"
