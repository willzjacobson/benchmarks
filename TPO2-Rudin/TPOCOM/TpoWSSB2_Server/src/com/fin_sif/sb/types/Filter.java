 ...
 */
		...
		public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://sb.fin-sif.com/types",
                                        ...
                                        if (localExpression != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localExpression));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("expression cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        @SuppressWarnings("rawtypes")
		public static Filter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Filter object =
                new Filter();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"Filter".equals(type)){
                                ...
                                return (Filter)com.fin_sif.sb.services.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://sb.fin-sif.com/types","expression").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"expression" +"  cannot be null");
                                    }
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://sb.fin-sif.com/types","value").equals(reader.getName())){
                                    ...
                                    list2.add(reader.getElementText());
                                            ...
                                            while(!loopDone2){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://sb.fin-sif.com/types","value").equals(reader.getName())){
                                                         list2.add(reader.getElementText());
