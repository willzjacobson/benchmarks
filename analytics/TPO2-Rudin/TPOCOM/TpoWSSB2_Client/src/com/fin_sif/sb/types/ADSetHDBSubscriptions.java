 ...
 */
            ...
            /**
            *  ADSetHDBSubscriptions bean class
            */
            @SuppressWarnings({"unchecked","unused", "serial"})
        
        public  class ADSetHDBSubscriptions
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://sb.fin-sif.com/types",
                "ADSetHDBSubscriptions",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ADSetHDBSubscriptions",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ADSetHDBSubscriptions",
    ...
    public static class Factory{
        ...
        */
        @SuppressWarnings("rawtypes")
		public static ADSetHDBSubscriptions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ADSetHDBSubscriptions object =
                new ADSetHDBSubscriptions();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ADSetHDBSubscriptions".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ADSetHDBSubscriptions)com.fin_sif.sb.services.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(com.fin_sif.sb.types.Subscription.Factory.parse(reader));
