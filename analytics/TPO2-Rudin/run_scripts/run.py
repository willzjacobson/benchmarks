...
def main(argv):
	...
	usage = "usage:\n run.py {345_Park | 560_Lex} {startup | rampdown | trajectory | trajectory-gridsearch} [Configuration File]"
	
	
	if mode == 'startup' or mode == 'rampdown':
		mainScript += '\\startup_rampdown'
	elif mode == 'trajectory' or mode == 'trajectory-gridsearch':
	...
	if mode == 'trajectory-gridsearch':
		commandLine += ' gridSearch'
	commandLine = 'python ' +  commandLine + ' ' + configFile + ' ' + building
