from startup_rampdown.startupPredictor import startupPredictorLex
...
def main(argv):
    ...
    try:
        relevantHours = (datetime.time(4, 00), datetime.time(9,00))
        
        startupPred = startupPredictorLex(conn, cursor, paramObj, 14, now,
                                                                      1, performGridSearch,
