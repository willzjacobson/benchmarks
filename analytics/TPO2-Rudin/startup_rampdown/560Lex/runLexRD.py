from startup_rampdown.rampdownPredictor import rampdownPredictorLex
...
def main(argv):
    ...
    #paramObj.rampdownOutputTable = "[adkfjalkfjsdkf]"
    ...
    try:
        ...
        rampdownPred = rampdownPredictorLex(conn, cursor, paramObj, 14, now,
                                                                      1, performGridSearch,
                                                                      [8, 4, 2, 1],  relevantHours)
        rampdownPred.readFromDB()
        rampdownPred.autorun()
        rampdownPred.commitFinalPrediction(outputTable)#paramObj.rampdownOutputTable
