...
namespace SmartBuilding
{
    ...
    /// </summary>
    public partial class diboss_011_SpaceTempPredictionWeek : System.Web.UI.Page
    {
        ...
        private void PlotChart(string sensorid, string sensorname)
        {
            ...
            dbQueryStringm = "SELECT [Prediction_Date] AS TIMESTAMP, [MAPE] AS Value FROM [845].dbo.[845---------000TPOFORTEMSPA001---001_Stats] WHERE ([Prediction_Date] > '" + fromDate.ToString() + "') AND (Prediction_Date < '" + toDate.ToString() + "') AND (Floor = '" + fl + "') AND (Quadrant = '" + qd + "')  ORDER BY [Prediction_Date]";
