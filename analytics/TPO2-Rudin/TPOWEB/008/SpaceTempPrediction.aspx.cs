...
namespace SmartBuilding
{
    ...
    /// </summary>
    public partial class diboss_008_SpaceTempPrediction : System.Web.UI.Page
    {
        ...
        private void PlotTime()
        {
            ...
            dbQueryStartUpTime = "SELECT 80 AS Value, TIMESTAMP FROM [008_Prediction_Start_Up_Time] WHERE (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
            ...
            dbQueryRampDownTime = "SELECT 65 AS Value, TIMESTAMP FROM [008_Prediction_Ramp_Down_Time] WHERE (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
        ...
        private void PlotChart(string sensorid, string sensorname, int i)
        {
            ...
            //arrow for nowcast
            dbQueryStringArrow = "SELECT  [TIMESTAMP], [Value] FROM [dbo].[008_Prediction_Space_Temperature_" + sensorname + "_Start] UNION SELECT  [TIMESTAMP], [Value] FROM [dbo].[008_Prediction_Space_Temperature_" + sensorname + "_End] where (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
