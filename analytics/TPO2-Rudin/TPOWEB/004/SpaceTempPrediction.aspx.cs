...
namespace SmartBuilding
{
    ...
    /// </summary>
    public partial class diboss_004_SpaceTempPrediction : System.Web.UI.Page
    {
        ...
        private void FillData()
        {
            ...
            string querySensor = "SELECT DISTINCT TABLE_NAME, REPLACE(TABLE_NAME, '004_Prediction_Space_Temperature_', '') AS SHORT_NAME FROM Prediction_CONFIG WHERE TABLE_NAME LIKE '%004_Prediction_Space_Temperature%' ORDER BY TABLE_NAME";
        ...
        private void PlotTime()
        {
            ...
            dbQueryStartUpTime = "SELECT 80 AS Value, TIMESTAMP FROM [004_Prediction_Start_Up_Time] WHERE (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
            ...
            dbQueryRampDownTime = "SELECT 65 AS Value, TIMESTAMP FROM [004_Prediction_Ramp_Down_Time] WHERE (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
        ...
        private void PlotChart(string sensorid, string sensorname, int i)
        {
            ...
            dbQueryStringA = "SELECT TIMESTAMP, Value as Actual FROM [004_Actual_Space_Temperature_" + sensorname + "] where (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
            ...
            //chart series    
            dbQueryStringSAT = "SELECT Value, TIMESTAMP FROM [1BP].dbo.[1BP---------004BMSHVASFASAT---VAL001] WHERE (EQUIPMENT_NO = '001') AND (ZONE = 'Z" + sensorSATid + "') AND (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
            //SAT set-points
            dbQueryStringSATSP = "SELECT Value, TIMESTAMP FROM [1BP].dbo.[1BP---------004BMSHVASFASAT---STP001] WHERE (EQUIPMENT_NO = '001') AND (ZONE = 'Z" + sensorSATid + "') AND (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
            ...
            if (ShowSAT.Checked)
            {
                ...
                s.LegendText = "Z" + sensorSATid + "_SAT";
                ...
                s.Points.DataBindXY(myReader, "TIMESTAMP", myReader, "Value");
                s.LegendText = "Z" + sensorSATid + "_SAT_SP";
                s.ToolTip = s.LegendText;
            ...
            //arrow for nowcast
            dbQueryStringArrow = "SELECT  [TIMESTAMP], [Value] FROM [dbo].[004_Prediction_Space_Temperature_" + sensorname + "_Start] UNION SELECT  [TIMESTAMP], [Value] FROM [dbo].[004_Prediction_Space_Temperature_" + sensorname + "_End] where (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
