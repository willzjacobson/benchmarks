<%@ Page Language="c#" Inherits="SmartBuilding.diboss_004_SteamPrediction" AutoEventWireup="true" CodeFile="SteamPrediction.aspx.cs" %>
                ...
                <asp:Chart ID="Chart1" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Steam Prediction versus Actual" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
