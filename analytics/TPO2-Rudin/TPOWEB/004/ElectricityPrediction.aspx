<%@ Page Language="c#" Inherits="SmartBuilding.diboss_004_ElectricityPrediction" AutoEventWireup="true" CodeFile="ElectricityPrediction.aspx.cs" %>
                ...
                <asp:Chart ID="Chart1" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Electricity Usage Prediction versus Actual" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
