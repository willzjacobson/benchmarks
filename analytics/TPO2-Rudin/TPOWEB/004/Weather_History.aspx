<%@ Page Language="c#" Inherits="SmartBuilding.diboss_004_Weather_History" AutoEventWireup="true" CodeFile="Weather_History.aspx.cs" %>
        ...
        <tr>
            <td valign="top" align="center">
                ...
                <asp:Chart ID="Chart3" runat="server"
                    ...
                    BorderColor="26, 59, 105" Height="350px" Width="680px" ImageStorageMode="UseImageLocation" ImageLocation="..\TempImageFiles\ChartPic_#SEQ(300,3)">
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Outside Temperature" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                ...
                <asp:Chart ID="Chart4" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Outside DewPoint" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="false" IsTextAutoFit="true" TextWrapThreshold="50" Docking="Bottom" Name="Default" BackColor="Transparent"
                ...
                <asp:Chart ID="Chart1" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Outside Humidity" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="false" IsTextAutoFit="true" TextWrapThreshold="50" Docking="Bottom" Name="Default" BackColor="Transparent"
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                            ...
                            <Area3DStyle Rotation="10" Perspective="10" Inclination="15" IsRightAngleAxes="False"
                                WallWidth="0" IsClustered="False"></Area3DStyle>
                            <AxisY LineColor="64, 64, 64, 64" Title="Percentage" IsLabelAutoFit="False">
                                <LabelStyle Font="Trebuchet MS, 8.25pt, style=Bold" />
                                <MajorGrid LineColor="64, 64, 64, 64" />
                            </AxisY>
                            <AxisX LineColor="64, 64, 64, 64" IsLabelAutoFit="False">
