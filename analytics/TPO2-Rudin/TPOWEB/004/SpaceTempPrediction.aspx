<%@ Page Language="c#" Inherits="SmartBuilding.diboss_004_SpaceTempPrediction" AutoEventWireup="true" CodeFile="SpaceTempPrediction.aspx.cs" %>
        ...
        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="DateTo" 
            PopupButtonID="Image2" />
                    ...
                    <tr>
                     ...
                     <tr>
                        <td colspan="2">
                            <asp:CheckBox runat="server" ID="ShowSAT" Checked="true" Text="Show SAT" />
                        </td>
                     </tr>
                    <tr>
                        <td colspan="2">
