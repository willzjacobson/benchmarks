<%@ Page Language="c#" Inherits="SmartBuilding.diboss_003_PredictionScoreAvg" AutoEventWireup="true" CodeFile="PredictionScoreAvg.aspx.cs" %>
...
<body>
    ...
    <table width="952" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td colspan="2" class="nav"><p>&nbsp;<a href="/TPO/TPO40E52.aspx">HOME</a> >> 40 East 52nd Street</p></td>
		</tr>
        <tr>
            ...
            <br />
                  ...
                  <asp:Chart ID="Chart1" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Electricity Forecast Score (RMSE 2 Weeks Running Average)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="true" IsTextAutoFit="true" TextWrapThreshold="50" Docking="Bottom" Name="Default" BackColor="Transparent"
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                            ...
                            <AxisY LineColor="64, 64, 64, 64" Title="kW" IsLabelAutoFit="False">
                ...
                <asp:Chart ID="Chart3" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Steam Forecast Score (RMSE 2 Weeks Running Average)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="true" IsTextAutoFit="true" TextWrapThreshold="50" Docking="Bottom" Name="Default" BackColor="Transparent"
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                            ...
                            <Area3DStyle Rotation="10" Perspective="10" Inclination="15" IsRightAngleAxes="False"
                                WallWidth="0" IsClustered="False"></Area3DStyle>
                            <AxisY LineColor="64, 64, 64, 64" Title="Mlb/hour" IsLabelAutoFit="False">
                                <LabelStyle Font="Trebuchet MS, 8.25pt, style=Bold" />
                                <MajorGrid LineColor="64, 64, 64, 64" />
                            </AxisY>
                            <AxisX LineColor="64, 64, 64, 64" IsLabelAutoFit="False">
                ...
                <asp:Chart ID="Chart4" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Occupancy Forecast Score (RMSE 2 Weeks Running Average)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="true" IsTextAutoFit="true" TextWrapThreshold="50" Docking="Bottom" Name="Default" BackColor="Transparent"
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                            ...
                            <Area3DStyle Rotation="10" Perspective="10" Inclination="15" IsRightAngleAxes="False"
                                WallWidth="0" IsClustered="False"></Area3DStyle>
                            <AxisY LineColor="64, 64, 64, 64" Title="# People" IsLabelAutoFit="False">
                                <LabelStyle Font="Trebuchet MS, 8.25pt, style=Bold" />
                                <MajorGrid LineColor="64, 64, 64, 64" />
                            </AxisY>
                            <AxisX LineColor="64, 64, 64, 64" IsLabelAutoFit="False">
                ...
                <asp:Chart ID="Chart2" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Space Temperature Forecast Score (RMSE 2 Weeks Running Average)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="false" IsTextAutoFit="true" TextWrapThreshold="50" Docking="Bottom" Name="Default" BackColor="Transparent"
                            Font="Trebuchet MS, 8.25pt, style=Bold">
                        </asp:Legend>
                    </Legends>
                    <BorderSkin SkinStyle="Emboss"></BorderSkin>
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                            ...
                            <Area3DStyle Rotation="10" Perspective="10" Inclination="15" IsRightAngleAxes="False"
                                WallWidth="0" IsClustered="False"></Area3DStyle>
                            <AxisY LineColor="64, 64, 64, 64" Title="°Fahrenheit" IsLabelAutoFit="False">
                                <LabelStyle Font="Trebuchet MS, 8.25pt, style=Bold" />
                                <MajorGrid LineColor="64, 64, 64, 64" />
                            </AxisY>
                            <AxisX LineColor="64, 64, 64, 64" IsLabelAutoFit="False">
        ...
        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="DateTo" 
            PopupButtonID="Image2" />
                    ...
                    <tr>
                        <td colspan="2">
                           <a id="A1" href="#" onclick="javascript: CheckBoxListSelect ('<%= SensorTypeList.ClientID %>',true)">All</a>
