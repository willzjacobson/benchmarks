<%@ Page Language="c#" Inherits="SmartBuilding.diboss_003_PredictionScore" AutoEventWireup="true" CodeFile="PredictionScore.aspx.cs" %>
        ...
        <tr>
            ...
            <br />
                  ...
                  <asp:Chart ID="Chart1" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Electricity Forecast Score (RMSE)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                ...
                <asp:Chart ID="Chart3" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Steam Forecast Score (RMSE)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="true" IsTextAutoFit="true" TextWrapThreshold="50" Docking="Bottom" Name="Default" BackColor="Transparent"
                ...
                <asp:Chart ID="Chart4" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Occupancy Forecast Score (RMSE)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="true" IsTextAutoFit="true" TextWrapThreshold="50" Docking="Bottom" Name="Default" BackColor="Transparent"
                ...
                <asp:Chart ID="Chart2" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Space Temperature Forecast Score (RMSE)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
