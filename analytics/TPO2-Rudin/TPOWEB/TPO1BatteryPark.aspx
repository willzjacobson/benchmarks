        ...
        <tr>
            ...
            <table border="0" cellpadding="3" cellspacing="3">
                <tr>
                    ...
                    <td align="center"><a href="004/SteamPrediction.aspx"><asp:Imagebutton ID="ImageButton4" runat="server" PostBackUrl="004/SteamPrediction.aspx" ImageURL="images/diboss/square-g.png" onmouseover="this.src='images/diboss/square-y.png'" onmouseout="this.src='images/diboss/square-g.png'" /><br />Steam Usage Prediction</a></td>
                </tr>
                <tr>
	            ...
	            <tr>
                    ...
                    <td align="center"><a href="004/RecommendationScore.aspx"><asp:Imagebutton ID="ImageButton13" runat="server" PostBackUrl="004/RecommendationScore.aspx" ImageURL="images/diboss/square-g.png" onmouseover="this.src='images/diboss/square-y.png'" onmouseout="this.src='images/diboss/square-g.png'" /><br />Recommendation Score</a></td>
	            ...
	            <tr>
		            ...
		            <td align="center"><a href="004/RecommendationScoreAvg.aspx"><asp:Imagebutton ID="ImageButton12" runat="server" PostBackUrl="004/RecommendationScoreAvg.aspx" ImageURL="images/diboss/square-g.png" onmouseover="this.src='images/diboss/square-y.png'" onmouseout="this.src='images/diboss/square-g.png'" /><br />Recommendation Score Rolling Average</a></td>
                    <td align="center"><a href="004/Weather_History.aspx"><asp:Imagebutton ID="ImageButton15" runat="server" PostBackUrl="004/Weather_History.aspx" ImageURL="images/diboss/square-g.png" onmouseover="this.src='images/diboss/square-y.png'" onmouseout="this.src='images/diboss/square-g.png'" /><br />Weather History</a></td>
                    <td align="center"></td>
                    <td align="center"></td>
	            </tr>
            </table>
