<%@ Page Language="c#" Inherits="SmartBuilding.diboss_006_SpaceTempPrediction" AutoEventWireup="true" CodeFile="SpaceTempPrediction.aspx.cs" %>
                    ...
                    <tr>
                        <td  colspan="2" nowrap >
                            <asp:RadioButtonList id="DateRange" runat="server">
                               <asp:ListItem Value="default" selected="true">Day-Ahead vs Actual</asp:ListItem>
        ...
        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="DateTo" 
            PopupButtonID="Image2" />
                    ...
                    <tr>
                     ...
                     <tr>
                        <td colspan="2">
                            <asp:CheckBox runat="server" ID="ShowNowcast" Checked="true" Text="Show Nowcast" />
                        </td>
                     </tr>
                    <tr>
                        <td colspan="2">
