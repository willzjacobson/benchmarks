...
namespace SmartBuilding
{
    ...
    public partial class diboss_006_SteamPrediction : System.Web.UI.Page
    {
        ...
        private void FillData()
        {
            ...
            dbQueryStringa = "SELECT Value AS Actual, TIMESTAMP FROM [WHI].dbo.[WHI---------006BMSSTEMET------VAL001] where (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
            ...
            dbQueryStartUpTime = "SELECT 30 AS Value, TIMESTAMP FROM [006_Prediction_Start_Up_Time] WHERE (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
