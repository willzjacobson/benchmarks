<%@ Page Language="c#" Inherits="SmartBuilding.diboss_001_ASC_Output_Occupancy" AutoEventWireup="true" CodeFile="ASC_Output_Occupancy.aspx.cs" %>
                ...
                <asp:Chart ID="Chart2" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="ASC Output Occupancy" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
