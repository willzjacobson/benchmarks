...
namespace SmartBuilding
{
    ...
    /// </summary>
    public partial class diboss_001_ASC_Output_Electric : System.Web.UI.Page
    {
        ...
        private void PlotChart(string runtime, string sensorid, int i)
        {
            ...
            Series r;
                ...
                dbQueryStringm = "SELECT [TIMESTAMP],[VALUE] AS Value FROM [345].[dbo].[asc_output_electric] WHERE EQUIPMENT_NO = '" + sensorid + "' AND [RUNTIME] = '" + runtime + "'  ORDER BY [TIMESTAMP]";

                dbQueryStringr = "SELECT [TIMESTAMP],[VALUE] AS Value FROM  [345].dbo.[345---------001BMSELEMET------VAL001] WHERE EQUIPMENT_NO = '" + sensorid + "' AND [TIMESTAMP] >= DATEADD(hour,-12,(SELECT MIN([TIMESTAMP]) FROM [345].[dbo].[asc_output_electric] WHERE EQUIPMENT_NO = '" + sensorid + "' AND [RUNTIME] = '" + runtime + "')) AND [TIMESTAMP] <= (SELECT MAX([TIMESTAMP]) FROM [345].[dbo].[asc_output_electric] WHERE EQUIPMENT_NO = '" + sensorid + "' AND [RUNTIME] = '" + runtime + "')  ORDER BY [TIMESTAMP]";
