<%@ Page Language="c#" Inherits="SmartBuilding.diboss_001_ASC_Output_Temp" AutoEventWireup="true" CodeFile="ASC_Output_Temp.aspx.cs" %>
                ...
                <asp:Chart ID="Chart2" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="ASC Output Temp" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                            ...
                            <AxisY LineColor="64, 64, 64, 64" Title="Value" Minimum="60" Maximum="80" IsLabelAutoFit="False">
