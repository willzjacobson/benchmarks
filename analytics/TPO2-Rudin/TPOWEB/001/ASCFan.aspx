<%@ Page Language="c#" Inherits="SmartBuilding.diboss_001_ASCFan" AutoEventWireup="true" CodeFile="ASCFan.aspx.cs" %>
    ...
    <table width="1152" align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
             ...
             <asp:Chart ID="Chart2" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="HVAC FAN (latest 24 hours)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
            ...
            <td align="left" valign="top">
                ...
                <h1>FUTURE FAN ACTIONS</h1><br /><br />
               <asp:GridView ID="DataPoints" AutoGenerateColumns="false"
 runat="server" AllowSorting="False"  DataSourceID="DataPointsDS"
           CssClass="nowrap">

                <Columns>

                  <asp:BoundField ItemStyle-HorizontalAlign="Right" DataField="ZONE" HeaderText="ZONE"/>
                  <asp:BoundField ItemStyle-HorizontalAlign="Right" DataField="FLOOR"   HeaderText="FLOOR"/>      
                  <asp:BoundField ItemStyle-HorizontalAlign="Right" DataField="QUADRANT" HeaderText="QUADRANT"/>
                  <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="EQUIPMENT_NO"   HeaderText="FAN ID"/>   
                  <asp:BoundField ItemStyle-HorizontalAlign="Left" DataField="TIMESTAMP" DataFormatString="{0:G}"  HeaderText="TIME"/>
                  <asp:BoundField ItemStyle-HorizontalAlign="Left" DataField="ACTION"   HeaderText="ACTION"/>   

                  </Columns>
                </asp:GridView>
                <asp:SqlDataSource ID="DataPointsDS" runat="server" ConnectionString="<%$ ConnectionStrings:TPOWEB %>"
                    SelectCommand="SELECT [ZONE],[FLOOR],[QUADRANT],[EQUIPMENT_NO],[TIMESTAMP],[ACTION] FROM [TPOWEB].[dbo].[001_TPOHVAFANLCP_LASTRUN_DELTA_ACTION] where timestamp > GETDATE() order by timestamp, equipment_NO">
                </asp:SqlDataSource>
            ...
            <br />
                <asp:Chart ID="Chart3" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="PUMP (latest 24 hours)" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="true" IsTextAutoFit="true" Docking="Bottom" Name="Default" BackColor="Transparent"
            ...
            <td align="left" valign="top">
                ...
                <h1>FUTURE PUMP ACTIONS</h1><br /><br />
               <asp:GridView ID="GridView1" AutoGenerateColumns="false"
 runat="server" AllowSorting="False"  DataSourceID="SqlDataSource1"
           CssClass="nowrap">
                ...
                <Columns>
                  ...
                  <asp:BoundField ItemStyle-HorizontalAlign="Right" DataField="FLOOR"   HeaderText="FLOOR"/>      
                  <asp:BoundField ItemStyle-HorizontalAlign="Right" DataField="QUADRANT" HeaderText="QUADRANT"/>
                  <asp:BoundField ItemStyle-HorizontalAlign="Center" DataField="EQUIPMENT_NO"   HeaderText="PUMP ID"/>   
                  <asp:BoundField ItemStyle-HorizontalAlign="Left" DataField="TIMESTAMP" DataFormatString="{0:G}"  HeaderText="TIME"/>
                  <asp:BoundField ItemStyle-HorizontalAlign="Left" DataField="ACTION"   HeaderText="ACTION"/>   

                  </Columns>
                </asp:GridView>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TPOWEB %>"
                    SelectCommand="SELECT [ZONE],[FLOOR],[QUADRANT],[EQUIPMENT_NO],[TIMESTAMP],[ACTION] FROM [TPOWEB].[dbo].[001_TPOWATSECPUM_LASTRUN_DELTA_ACTION] where timestamp > GETDATE() order by timestamp, equipment_NO">
                </asp:SqlDataSource>
            ...
            <br />
                ...
                <asp:Chart ID="Chart1" runat="server"
                    ...
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Space Temperature Prediction versus Actual" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="true" IsTextAutoFit="true" Docking="Bottom" Name="Default" BackColor="Transparent"
        ...
        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="DateTo" 
            PopupButtonID="Image2" />
                    ...
                    <tr>
                     ...
                     <tr>
                        <td colspan="2">
                            <asp:CheckBox runat="server" ID="ShowBounds2" Checked="false" Text="Show 68% Confidence" />
                        </td>
                     </tr>
                     <tr>
                        <td colspan="2">
