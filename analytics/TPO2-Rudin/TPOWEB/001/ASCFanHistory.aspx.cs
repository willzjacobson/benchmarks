...
namespace SmartBuilding
{
    ...
    /// </summary>
    public partial class diboss_001_ASCFanHistory : System.Web.UI.Page
    {
        ...
        private void FillData()
        {
            ...
            string queryRuntime = "SELECT DISTINCT [RUNTIME] FROM [345].[dbo].[345---------001TPOHVAFANLCP---VAL001] ORDER BY [RUNTIME] DESC";
        ...
        private void PlotChart(string runtime)
        {
            ...
            foreach (DataRow data in dsEquipment.Tables[0].Rows)
            {
                ...
                dbQueryStringm = "SELECT [TIMESTAMP],([VALUE]+" + count + ") AS Value FROM [345].[dbo].[345---------001TPOHVAFANLCP---VAL001] WHERE EQUIPMENT_NO = '" + data[0] + "' AND [RUNTIME] = '" + runtime + "'  ORDER BY [TIMESTAMP]";
