...
namespace SmartBuilding
{
    ...
    /// </summary>
    public partial class diboss_001_ASC_Output_VFD : System.Web.UI.Page
    {
        ...
        private void FillData()
        {
            ...
            string queryRuntime = "SELECT DISTINCT [RUNTIME] FROM [345].[dbo].[345---------001TPOHVAFANFDB---VAL001] ORDER BY [RUNTIME] DESC";
            ...
            string querySensor = "SELECT DISTINCT FLOOR + '_' + EQUIPMENT_NO AS SHORT_NAME FROM [345].[dbo].[345---------001TPOHVAFANFDB---VAL001] ORDER BY FLOOR + '_' + EQUIPMENT_NO";
        ...
        private void PlotChart(string runtime, string sensorid, int i)
        {
            ...
            dbQueryStringm = "SELECT [TIMESTAMP],[VALUE] AS Value FROM [345].[dbo].[345---------001TPOHVAFANFDB---VAL001] WHERE FLOOR + '_' + EQUIPMENT_NO = '" + sensorid + "' AND [RUNTIME] = '" + runtime + "'  ORDER BY [TIMESTAMP]";

            dbQueryStringr = "SELECT [TIMESTAMP],[VALUE] AS Value FROM  [345].dbo.[345---------001BMSHVAFANFDB---VAL001] WHERE FLOOR + '_' + EQUIPMENT_NO = '" + sensorid + "' AND [TIMESTAMP] >= DATEADD(hour,-12,(SELECT MIN([TIMESTAMP]) FROM [345].[dbo].[345---------001TPOHVAFANFDB---VAL001] WHERE FLOOR + '_' + EQUIPMENT_NO = '" + sensorid + "' AND [RUNTIME] = '" + runtime + "')) AND [TIMESTAMP] <= (SELECT MAX([TIMESTAMP]) FROM [345].[dbo].[345---------001TPOHVAFANFDB---VAL001] WHERE FLOOR + '_' + EQUIPMENT_NO = '" + sensorid + "' AND [RUNTIME] = '" + runtime + "')  ORDER BY [TIMESTAMP]";
                ...
                m.LegendText = sensorid.ToString();
                Chart2.Series.Add(m);
                ...
                r.LegendText = sensorid.ToString() + " Actual";
                Chart2.Series.Add(r);
