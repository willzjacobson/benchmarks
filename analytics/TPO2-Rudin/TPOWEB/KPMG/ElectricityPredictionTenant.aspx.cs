...
namespace SmartBuilding
{
    ...
    /// </summary>
    public partial class diboss_KPMG_ElectricityPredictionTenant : System.Web.UI.Page
    {
        ...
        private void FillData()
        {
            ...
            dbQueryStringa = "SELECT Value AS Actual, TIMESTAMP FROM dbo.[001_KPMG_ELEC] where (TIMESTAMP > '" + fromDate.ToString() + "') AND (TIMESTAMP < '" + toDate.ToString() + "') ORDER BY TIMESTAMP";
            dbQueryStringm = "SELECT [Prediction_Date] AS TIMESTAMP, [MAPE] AS Value FROM [345].dbo.[345---------000TPOFORELECON001---001_KPMG_stats] WHERE ([Prediction_Date] > '" + fromDate.ToString() + "') AND (Prediction_Date < '" + toDate.ToString() + "') ORDER BY [Prediction_Date]";
