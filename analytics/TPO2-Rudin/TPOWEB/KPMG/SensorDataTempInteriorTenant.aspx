<%@ Page Language="c#" Inherits="SmartBuilding.diboss_KPMG_SensorDataTempInteriorTenant" AutoEventWireup="true" CodeFile="SensorDataTempInteriorTenant.aspx.cs" %>
...
<head id="Head1" runat="server">
    ...
    <title>TPO</title>
        <script language="javascript" type="text/javascript">
            ...
            function CheckBoxListSelectLower(cbControl, state) {
                var chkBoxList = document.getElementById(cbControl);
                var chkBoxCount = chkBoxList.getElementsByTagName("input");
                for (var i = 0; i < chkBoxCount.length; i++) {
            ...
            function CheckBoxListSelectUpper(cbControl, state) {
                var chkBoxList = document.getElementById(cbControl);
                var chkBoxCount = chkBoxList.getElementsByTagName("input");
                for (var i = 0; i < chkBoxCount.length; i++) {
                    chkBoxCount[i].checked = false;
                ...
                for (var i = 17; i < 25; i = i + 2) {
                    chkBoxCount[i].checked = true;
                }
                for (var i = 16; i < 24; i = i + 2) {
                    chkBoxCount[i].checked = true;
                }
                return false;
            }
        ...
        <tr>
            ...
            <br />
                <asp:Chart ID="Chart1" runat="server"
                    ...
                    BorderColor="26, 59, 105" Height="600px" Width="680px" ImageStorageMode="UseImageLocation" ImageLocation="..\TempImageFiles\ChartPic_#SEQ(300,3)">
                    <Titles>
                        <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 12pt, style=Bold" ShadowOffset="3"
                            Text="Tenant Interior Space Temperature" ForeColor="26, 59, 105">
                        </asp:Title>
                    </Titles>
                    <Legends>
                        <asp:Legend Enabled="false" IsTextAutoFit="true" Docking="Bottom" Name="Default" BackColor="Transparent"
                    ...
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BorderColor="64, 64, 64, 64" BorderDashStyle="Solid"
                            ...
                            <AxisY LineColor="64, 64, 64, 64" Title="°Fahrenheit" Minimum="60" Maximum="90" IsLabelAutoFit="False">
            ...
            <td align="left" valign="top">
                <table align="center" cellpadding="4">
                    <tr>
                     ...
                     <tr>
                        <td  colspan="2" nowrap >
                            <asp:CheckBoxList ID="SensorTypeList" runat="server" RepeatColumns="2" AutoPostBack="True" CssClass="cblist">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            ...
                            <a id="A3" href="#" onclick="javascript: CheckBoxListSelectUpper ('<%= SensorTypeList.ClientID %>',true)">Upper</a>
| <a id="A4" href="#" onclick="javascript: CheckBoxListSelectLower ('<%= SensorTypeList.ClientID %>',true)">Lower</a> | <a id="A1" href="#" onclick="javascript: CheckBoxListSelect ('<%= SensorTypeList.ClientID %>',true)">All</a>
| <a id="A2" href="#" onclick="javascript: CheckBoxListSelect ('<%= SensorTypeList.ClientID %>',false)">None</a>    
                        </td>
                     </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td  colspan="2" nowrap >
                            <asp:RadioButtonList id="DateRange" runat="server">
                               <asp:ListItem Value="default" selected="true">Last 24 hours</asp:ListItem>
                               <asp:ListItem Value="custom">Use Date Range Below</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                    <tr>
