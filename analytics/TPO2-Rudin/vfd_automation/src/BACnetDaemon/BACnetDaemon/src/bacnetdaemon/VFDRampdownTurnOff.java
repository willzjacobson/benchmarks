...
public class VFDRampdownTurnOff {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Encodable value = new com.serotonin.bacnet4j.type.enumerated.BinaryPV(0);
            String result = "PRESENT VALUE NOT CHANGED BY VFDRampdownTurnOff";
            ...
            for (ObjectIdentifier oid : oidss) {
                ...
                if (oid.getInstanceNumber()==7015){
                    ...
                    System.out.println("***PRESENT VALUE SET TO 0 FOR: " + oid.getInstanceNumber() + " ***");
                    result = "PRESENT VALUE SET TO 0 FOR: " + oid.getInstanceNumber();
                }
