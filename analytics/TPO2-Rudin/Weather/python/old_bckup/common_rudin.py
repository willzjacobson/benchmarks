...
def add_std_opts(ogrp, cgrp, ks, add_ml_commands=True):
  ...
  # ogrp.add_option('--building_floor', type='int',
    # help='building floor')
  # cgrp.add_option('building_floor', keys=ks)

  # ogrp.add_option('--floor_quadrant',
    # help='floor quadrant')
  # cgrp.add_option('floor_quadrant', keys=ks)
  ...
  # ogrp.add_option('--db_user', help='database username')
  # cgrp.add_option('db_user', keys=ks)

  # ogrp.add_option('--db_pwd', help='database password')
  # cgrp.add_option('db_pwd', keys=ks)

  # ogrp.add_option('--space_temp_tablename_format',
	# help='space temperature table name format')
  ...
  ogrp.add_option('--weather_station_ids',
	help='comma separated list of all weather station ids')
  ...
  cgrp.add_option('use_weather_forecast', keys=ks)
