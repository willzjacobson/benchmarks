...
#                 collection_name, building, dt, devices, systems=None):

    # dt_ts = get_parsed_ts_new_schema1(host, port, db_name, username, password,
    #                                   source, collection_name, building,
    #                                   devices, systems=systems, ts_date=dt)
    # print(dt_ts)